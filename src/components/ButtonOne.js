...
export const calcFinderMoveOnePokemonOneTypeOne = (props) => {
    const move = props.pokemon.selectionOneMoveOneType
...
export const calcFinderMoveOnePokemonOneTypeTwo = (props) => {
    const move = props.pokemon.selectionOneMoveOneType
